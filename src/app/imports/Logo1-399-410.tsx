import svgPaths from "./svg-8owkgkofay";
  ...
  return (
    <div className={className || "content-stretch flex flex-col h-[15px] items-start relative w-[73px]"} data-name="Logo 1">
      <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid items-[start] justify-items-[start] leading-[0] relative shrink-0">
        ...
        <p className="col-1 font-['Tilt_Warp:Regular',sans-serif] h-[13px] leading-[normal] ml-[19px] mt-0 relative row-1 text-[#2f2f3b] text-[12px] tracking-[0.12px] uppercase w-[54px] whitespace-pre-wrap" style={{ fontVariationSettings: "'XROT' 0, 'YROT' 0" }}>
          Flowdee
        </p>
      </div>
    </div>
